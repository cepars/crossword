  ...
  drawGrid() {
    ...
    this.grid.forEach((row, i) => {
      ...
      row.forEach((letter, j) => {
        html += `<td id="cell-${i}-${j}" style="padding:5px;border:1px solid #ccc;font-size:20px;cursor:pointer;text-align:center">${letter}</td>`;
      });
      html += '</tr>';
    });
    html += '</table><p>Find as many animals as possible.</p>';
